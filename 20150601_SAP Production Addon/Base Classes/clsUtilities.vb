...
Public Class clsUtilities
    ...
    Public Sub RemoveUnIssuedItems(ByVal aForm As SAPbouiCOM.Form)
        Try
            aForm.Freeze(True)
            ...
            For intRow As Integer = oMatrix.RowCount To 1 Step -1
                If getMatrixValues(oMatrix, "4", intRow) <> "" Then


                    oCombo = oMatrix.Columns.Item("9").Cells.Item(intRow).Specific
                    Try
                        '   MsgBox(oCombo.Selected.Value)
                    Catch ex As Exception

                    End Try
                    If getDocumentQuantity(getMatrixValues(oMatrix, "13", intRow)) = 0 Then
